      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <p className="text-lg sm:text-xl md:text-2xl leading-relaxed text-foreground/90 font-medium px-2">
            En <span className="font-bold text-accent">Real de Catorce</span> somos una empresa especializada en logística alimentaria, 
          ...
          {benefits.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className={`relative flex flex-col items-center text-center ${colors.bg} border ${colors.border} rounded-2xl p-6 sm:p-7 md:p-8 backdrop-blur-sm transition-all duration-300`}
              >
                <motion.div 
                ...
                <h3 className="mb-3 text-foreground font-semibold text-lg uppercase tracking-wide">
                  {item.title}
                </h3>
